...
class CameraViewController: UIViewController {
    ...
    public var ValueA:Int=0
    public var ValueB:Int=0
    public var ValueC:Int=0
    public var ValueD:Int=0
    //The game developer will
   ...
   public func serial ()
    {
        ...
        serialQueue.async {
            ...
            let VF=HomeStore.shared.homeManager.homes[0].accessories[0]
            concurrentQueue.async {
                VF.services[1].characteristics[0].writeValue(self.ValueA)
                { error in
                    print(error ?? 0)
                    if let error = error {
                        // 错误处理
                ...
                debugPrint(HomeStore.shared.homeManager.homes[0].accessories[0].services[1].characteristics[0].value!)
                debugPrint("success")
            }
